...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product->descriptiion = $request->descriptiion;
        ...
        $product->save();
        return redirect()->route('product.index')->with('succes', 'Data Berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $product ->save();
        return redirect()->route('product.index')->with('succes', 'Data Berhasil dirubah!!');
    }
